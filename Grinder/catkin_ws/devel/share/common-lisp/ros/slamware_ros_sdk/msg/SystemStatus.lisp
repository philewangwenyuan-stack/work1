...
(cl:defmethod cl:initialize-instance :after ((m <SystemStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SystemStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name slamware_ros_sdk-msg:<SystemStatus> is deprecated: use slamware_ros_sdk-msg:SystemStatus instead.")))

(cl:ensure-generic-function 'timestamp_ns-val :lambda-list '(m))
(cl:defmethod timestamp_ns-val ((m <SystemStatus>))
...
(cl:defmethod status-val ((m <SystemStatus>))

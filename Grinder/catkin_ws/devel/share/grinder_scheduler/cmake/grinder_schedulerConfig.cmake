...
if(NOT "/home/neardi/work/Grinder/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'grinder_scheduler' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/neardi/work/Grinder/catkin_ws/src/grinder_scheduler/${idir}'.  ${_report}")
    endif()
